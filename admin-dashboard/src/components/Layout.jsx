        ...
        <div className="flex flex-col h-full w-64">
          ...
          <div className="flex items-center px-5 py-6 border-b border-gray-200 dark:border-[#222]">
            ...
            <div className="ml-3 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity duration-300 overflow-hidden">
              ...
              <p className="text-[11px] text-gray-500 font-medium tracking-wide uppercase whitespace-nowrap">Admin Portal</p>
            </div>
            <button
        ...
        >
          <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-3">
              ...
              <div className="hidden sm:block">
                <nav className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400 font-medium">
                  <span className="text-black dark:text-white font-bold">Admin Portal</span>
                  <span>/</span>
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Notifications */}
              <button className="relative p-2 text-gray-500 hover:text-black dark:hover:text-white bg-gray-50 dark:bg-[#1a1a1a] hover:bg-gray-200 dark:hover:bg-[#333] rounded-full transition-all duration-300 border border-gray-200 dark:border-[#333]">
